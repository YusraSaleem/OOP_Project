...
public class ViewHotels extends JFrame implements Runnable {
    ...
    String[] txt = {"Mahali Mzuri","Capella Bangkok","Grace Hotel","Kamalame Cay","Juluchuca Mexico"};

    public void run () {
        try {
            for (int j = 0; j <= 4; j++) {
                labels[j].setVisible(true);
                caption.setText(txt[j]);
                Thread.sleep(2000);
        ...
        ViewHotels() {
            ...
            String[] list = {"HotelImages/hotel1.jpg","HotelImages/hotel2.jpg","HotelImages/hotel3.jpg","HotelImages/hotel4.jpg","HotelImages/hotel5.jpg"};
